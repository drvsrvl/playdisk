...
<div style="width:100%;background: linear-gradient(180deg, rgb(45, 45, 45) 0%, rgb(0,0,0) 100%); padding-bottom:20px; padding-top: 30px; box-shadow: rgba(0, 0, 0, 0.2) 0px 4px 24px;">
    ...
    <div class="infolista" style="justify-content:space-between; height:100px">
            ...
            <h3>Configuración > Novo xénero</h3>
        </div>
    <hr/>
    <div class="cancionslista px-4">
        <form action="/admin/xenero" method="post" enctype="multipart/form-data" style="width:100%;">
            @csrf
            <div class="py-3" style="display:flex;align-items:center;justify-content:center;width:100%;flex-direction:row">
                <h5>Nome</h5>
                <input 
                    class="mx-4"
                    type="text" 
